...
const REVIEW_API = '/api/sales';       // sales ledger
...
async function openReviewModal(billId) {
    ...
    document.getElementById('reviewBody').innerHTML =
        '<div class="review-loading"><div class="loading-spinner"></div> Re-checking this invoice…</div>';
    try {
...
function renderReviewModal(d) {
    ...
    const buttons = [
        ...
        `<button class="btn btn-secondary btn-sm" onclick="reviewOpenEdit()">Edit invoice</button>`,
...
async function bulkReprocessFlagged() {
    ...
    footer.style.display = 'flex';
    document.getElementById('reprocessApplyBtn').style.display = 'none';
    document.getElementById('reprocessCancelBtn').textContent = 'Close';
...
async function saveProject(billId, project, moveToNext = false) {
    ...
    // Guard: reject non-canonical values client-side.
